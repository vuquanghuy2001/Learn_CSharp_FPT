#pragma checksum "E:\Hoc_Tap\Learn_CSharp_FPT\Learn_CSharp_UWP\U049\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "97D8EC723821C54D3C9E3B1A6288E926"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace U049
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj5_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::U049.Model.MenuItem dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::U049.Model.MenuItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::U049.Model.MenuItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::U049.Model.MenuItem obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Category(global::U049.Model.SoundCategory obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj12_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::U049.Model.Sound dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 85 && columnNumber == 78)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::U049.Model.Sound) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::U049.Model.Sound)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::U049.Model.Sound obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::U049.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::U049.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::U049.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_MenuItems(global::System.Collections.Generic.List<global::U049.Model.MenuItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Sounds(global::System.Collections.ObjectModel.ObservableCollection<global::U049.Model.Sound> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 10: // MainPage.xaml line 76
                {
                    ...
                    ((global::Windows.UI.Xaml.Controls.GridView)this.SoundGridView).Drop += this.SoundGridView_DragOver;
                    ((global::Windows.UI.Xaml.Controls.GridView)this.SoundGridView).ItemClick += this.SoundGridView_ItemClick;
                    ((global::Windows.UI.Xaml.Controls.GridView)this.SoundGridView).SelectionChanged += this.SoundGridView_SelectionChanged;
                }
                break;
